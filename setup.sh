...
printf "\033[1;31m/* Installing PHP 7.1 using PPA ... /\033[0m\n"
sudo apt-get install -y python-software-properties
sudo add-apt-repository ppa:ondrej/php
sudo apt-get update
sudo apt-get install -y php7.1

printf "\033[1;31m/* Installing Additional PHP 7.1 Moduless ... /\033[0m\n"
...
sudo a2enmod php7.1
printf "\033[1;31m/* install PHP 7.1 curl ... /\033[0m\n"
...
printf "\033[1;31m/* Installing CURL ... /\033[0m\n"
